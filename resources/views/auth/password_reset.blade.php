...
<title>Do-B-Do Reset Password</title>
<!-- Bootstrap Core CSS -->
			...
			<div class="col-md-4"></div>
				<div class="col-md-4">
					<div class="white-box">
						...
						{!! Form::open(['route' => 'reset.password','class' => 'form-horizontal new-lg-form','id' => 'loginform']) !!}
							@if($errors->any())
							...
							<div class="form-group">
								<div class="col-md-12">
									<a href="{{ url('login') }}" id="backToLogin" class="text-dark pull-right"><i class="fa fa-arrow-left m-r-5"></i> Back</a> </div>
							</div>
